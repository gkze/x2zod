import type { RuntimeDescriptor, RuntimeResource } from "@x2zod/runtime/json-schema";
...
export type { RuntimeDescriptor, RuntimeResource } from "@x2zod/runtime/json-schema";
