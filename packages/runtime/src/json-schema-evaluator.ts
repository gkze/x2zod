import type { RuntimeDescriptor, RuntimeResource } from "./json-schema-types";
...
export const x2zodEvaluateRuntimeDescriptors = (
...
export const runtimeEvaluatorFunctions: readonly Readonly<{
  name: string;
  toString: () => string;
}>[] = [
  x2zodRuntimeValueAt,
